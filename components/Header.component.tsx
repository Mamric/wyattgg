...
const externalLinks: NavLink[] = [
  { url: "https://youtube.com/scpWyatt", text: "YouTube", icon: YouTubeIcon },
  { url: "https://discord.gg/scpWyatt", text: "Discord", icon: DiscordIcon },
  { url: "https://x.com/scpwyatt", text: "Twitter", icon: XIcon },
];
